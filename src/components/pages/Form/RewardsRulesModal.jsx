...
const RewardsRulesModal = ({ isOpen, onClose, isFirstTime = false }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 m-4 max-w-lg w-full max-h-[90vh] overflow-y-auto relative flex flex-col items-center">
        <div className="flex flex-col items-center mb-4">
          ...
          <h2 className="text-lg mac:text-2xl font-bold text-[#08B7F6] arca mt-10">
          ...
          <div className='text-center font-sans font-semibold text-[#2C2C2C] text-[1rem] leading-[1.5rem] tab:text-[1.3rem] tab:leading-[2.1rem] mac:text-[1.2rem] mac:leading-[1.7rem] md:leading-[1.7rem] md:text-[1.1rem]'>
            <p className='my-4'><span className='uppercase text-[#080594] font-bold '>+100 CLEVO COINS</span> for every question answered!</p>
            <p className='my-4'>Build Streaks for every question! <br/>
              Every <span className='uppercase text-[#080594] font-bold '>5</span> streaks = earn +200 CLEVO COINS<br/>
              <span className=' text-[#080594] font-bold '>Streak breaks</span>  if you take a break </p>

            <p>Complete a section to
              <span className=' text-[#080594] font-bold '> Earn a badge</span></p>
        ...
        <button
          onClick={onClose}
          className="mt-6 w-[50%] bg-[#080594] text-white py-3 rounded-full font-bold hover:bg-blue-700 transition-colors"
        >
