          ...
          <div className="bg-[#F2F4F7] rounded-[30px] shadow-2xl p-8 w-full max-w-lg relative">
            ...
            <div className="text-center mb-8">
              <div className="mb-6 p-4 bg-white rounded-full w-fit mx-auto">
                <BiInfoCircle className="w-8 h-8 text-[#08B7F6]" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <button
                onClick={() => fun("no")}
                className="w-full sm:w-auto px-8 py-3 text-[15px] font-bold uppercase border-2 border-[#080594] text-[#080594] rounded-full hover:bg-[#080594] hover:text-white transition-all duration-200 opensans-bold bg-white"
              >
                Go Back
              </button>
              <button
                onClick={() => fun("yes")}
                className="w-full sm:w-auto px-10 py-3 text-[15px] font-bold uppercase bg-[#080594] text-white rounded-full hover:bg-[#0705C0] border-2 border-[#080594] hover:border-[#0705C0] transition-all duration-200 opensans-bold"
              >
                Submit
              </button>
            </div>
